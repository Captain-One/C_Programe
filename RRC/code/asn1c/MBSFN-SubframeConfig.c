...
static const asn_TYPE_tag2member_t asn_MAP_subframeAllocation_tag2el_10[] = {
...
static const ber_tlv_tag_t asn_DEF_MBSFN_SubframeConfig_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MBSFN_SubframeConfig_tag2el_1[] = {
