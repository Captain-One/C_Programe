...
static const int asn_MAP_cgi_Info_oms_4[] = { 1 };
...
static const int asn_MAP_MeasResultGERAN_oms_1[] = { 2 };
static const ber_tlv_tag_t asn_DEF_MeasResultGERAN_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MeasResultGERAN_tag2el_1[] = {
