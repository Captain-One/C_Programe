...
static const int asn_MAP_interRAT_Parameters_oms_9[] = { 0, 1, 2, 3, 4, 5, 6 };
static const ber_tlv_tag_t asn_DEF_interRAT_Parameters_tags_9[] = {
	(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_interRAT_Parameters_tag2el_9[] = {
...
static const int asn_MAP_UE_EUTRA_Capability_oms_1[] = { 6, 8 };
static const ber_tlv_tag_t asn_DEF_UE_EUTRA_Capability_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_EUTRA_Capability_tag2el_1[] = {
