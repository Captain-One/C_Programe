...
static const asn_INTEGER_enum_map_t asn_MAP_dualRxTxRedirectIndicator_r10_value2enum_2[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_dualRxTxRedirectIndicator_r10_enum2value_2[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_dualRxTxRedirectIndicator_r10_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_dualRxTxRedirectIndicator_r10_tags_2[] = {
...
static const int asn_MAP_HandoverFromEUTRAPreparationRequest_v1020_IEs_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_HandoverFromEUTRAPreparationRequest_v1020_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_HandoverFromEUTRAPreparationRequest_v1020_IEs_tag2el_1[] = {
