...
static const asn_INTEGER_enum_map_t asn_MAP_MIMO_CapabilityUL_r10_value2enum_1[] = {
	{ 0,	9,	"twoLayers" },
	{ 1,	10,	"fourLayers" }
};
static const unsigned int asn_MAP_MIMO_CapabilityUL_r10_enum2value_1[] = {
	1,	/* fourLayers(1) */
	0	/* twoLayers(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_MIMO_CapabilityUL_r10_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_MIMO_CapabilityUL_r10_tags_1[] = {
