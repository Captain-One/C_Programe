...
static const asn_INTEGER_enum_map_t asn_MAP_hoppingMode_value2enum_4[] = {
	{ 0,	13,	"interSubFrame" },
	{ 1,	21,	"intraAndInterSubFrame" }
};
static const unsigned int asn_MAP_hoppingMode_enum2value_4[] = {
	0,	/* interSubFrame(0) */
	1	/* intraAndInterSubFrame(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_hoppingMode_specs_4 = {
...
static const ber_tlv_tag_t asn_DEF_hoppingMode_tags_4[] = {
...
static const ber_tlv_tag_t asn_DEF_pusch_ConfigBasic_tags_2[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_pusch_ConfigBasic_tag2el_2[] = {
