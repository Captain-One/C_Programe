...
static const asn_INTEGER_enum_map_t asn_MAP_SupportedBandUTRA_FDD_value2enum_1[] = {
	{ 0,	5,	"bandI" },
	{ 1,	6,	"bandII" },
	{ 2,	7,	"bandIII" },
	{ 3,	6,	"bandIV" },
...
static const unsigned int asn_MAP_SupportedBandUTRA_FDD_enum2value_1[] = {
	0,	/* bandI(0) */
	1,	/* bandII(1) */
	2,	/* bandIII(2) */
	3,	/* bandIV(3) */
...
static const asn_INTEGER_specifics_t asn_SPC_SupportedBandUTRA_FDD_specs_1 = {
...
static const ber_tlv_tag_t asn_DEF_SupportedBandUTRA_FDD_tags_1[] = {
