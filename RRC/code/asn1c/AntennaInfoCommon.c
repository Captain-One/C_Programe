...
static const asn_INTEGER_enum_map_t asn_MAP_antennaPortsCount_value2enum_2[] = {
	{ 0,	3,	"an1" },
	{ 1,	3,	"an2" },
	{ 2,	3,	"an4" },
	{ 3,	6,	"spare1" }
};
static const unsigned int asn_MAP_antennaPortsCount_enum2value_2[] = {
	0,	/* an1(0) */
	1,	/* an2(1) */
	2,	/* an4(2) */
	3	/* spare1(3) */
};
static const asn_INTEGER_specifics_t asn_SPC_antennaPortsCount_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_antennaPortsCount_tags_2[] = {
...
static const ber_tlv_tag_t asn_DEF_AntennaInfoCommon_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_AntennaInfoCommon_tag2el_1[] = {
