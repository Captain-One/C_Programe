...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_5 = {
	sizeof(struct UE_EUTRA_Capability_v9a0_IEs__nonCriticalExtension),
	offsetof(struct UE_EUTRA_Capability_v9a0_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
static const int asn_MAP_UE_EUTRA_Capability_v9a0_IEs_oms_1[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_UE_EUTRA_Capability_v9a0_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_EUTRA_Capability_v9a0_IEs_tag2el_1[] = {
