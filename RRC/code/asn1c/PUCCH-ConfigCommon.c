...
static const asn_INTEGER_enum_map_t asn_MAP_deltaPUCCH_Shift_value2enum_2[] = {
	{ 0,	3,	"ds1" },
	{ 1,	3,	"ds2" },
	{ 2,	3,	"ds3" }
};
static const unsigned int asn_MAP_deltaPUCCH_Shift_enum2value_2[] = {
	0,	/* ds1(0) */
	1,	/* ds2(1) */
	2	/* ds3(2) */
};
static const asn_INTEGER_specifics_t asn_SPC_deltaPUCCH_Shift_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_deltaPUCCH_Shift_tags_2[] = {
