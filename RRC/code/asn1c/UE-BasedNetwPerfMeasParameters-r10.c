...
static const asn_INTEGER_enum_map_t asn_MAP_loggedMeasurementsIdle_r10_value2enum_2[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_loggedMeasurementsIdle_r10_enum2value_2[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_loggedMeasurementsIdle_r10_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_loggedMeasurementsIdle_r10_tags_2[] = {
...
static const asn_INTEGER_enum_map_t asn_MAP_standaloneGNSS_Location_r10_value2enum_4[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_standaloneGNSS_Location_r10_enum2value_4[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_standaloneGNSS_Location_r10_specs_4 = {
...
static const ber_tlv_tag_t asn_DEF_standaloneGNSS_Location_r10_tags_4[] = {
...
static const int asn_MAP_UE_BasedNetwPerfMeasParameters_r10_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_UE_BasedNetwPerfMeasParameters_r10_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_BasedNetwPerfMeasParameters_r10_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* loggedMeasurementsIdle-r10 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* standaloneGNSS-Location-r10 */
};
