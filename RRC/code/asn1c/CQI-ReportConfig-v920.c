...
static const asn_INTEGER_enum_map_t asn_MAP_cqi_Mask_r9_value2enum_2[] = {
	{ 0,	5,	"setup" }
};
static const unsigned int asn_MAP_cqi_Mask_r9_enum2value_2[] = {
	0	/* setup(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_cqi_Mask_r9_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_cqi_Mask_r9_tags_2[] = {
...
static const asn_INTEGER_enum_map_t asn_MAP_pmi_RI_Report_r9_value2enum_4[] = {
	{ 0,	5,	"setup" }
};
static const unsigned int asn_MAP_pmi_RI_Report_r9_enum2value_4[] = {
	0	/* setup(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_pmi_RI_Report_r9_specs_4 = {
...
static const ber_tlv_tag_t asn_DEF_pmi_RI_Report_r9_tags_4[] = {
...
static const int asn_MAP_CQI_ReportConfig_v920_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_CQI_ReportConfig_v920_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CQI_ReportConfig_v920_tag2el_1[] = {
