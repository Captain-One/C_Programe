...
static const asn_INTEGER_enum_map_t asn_MAP_csg_MemberStatus_r9_value2enum_2[] = {
	{ 0,	6,	"member" }
};
static const unsigned int asn_MAP_csg_MemberStatus_r9_enum2value_2[] = {
	0	/* member(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_csg_MemberStatus_r9_specs_2 = {
...
static const ber_tlv_tag_t asn_DEF_csg_MemberStatus_r9_tags_2[] = {
...
static const int asn_MAP_AdditionalSI_Info_r9_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_AdditionalSI_Info_r9_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_AdditionalSI_Info_r9_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* csg-MemberStatus-r9 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* csg-Identity-r9 */
};
