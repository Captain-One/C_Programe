...
static const ber_tlv_tag_t asn_DEF_RRCConnectionReconfigurationComplete_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_RRCConnectionReconfigurationComplete_tag2el_1[] = {
