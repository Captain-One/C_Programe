...
C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/ITarget.xs:
package.mak: C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/ITarget.xs
C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/C28_large.xs:
package.mak: C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/C28_large.xs
C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/C28_float.xs:
package.mak: C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/C28_float.xs
C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/package.xs:
package.mak: C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/package.xs
C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/elf/ITarget.xs:
package.mak: C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/elf/ITarget.xs
C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/elf/C28_float.xs:
package.mak: C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/elf/C28_float.xs
C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/elf/package.xs:
package.mak: C:/ti/sdk-k2h/bios_6_73_01_01/packages/ti/targets/elf/package.xs
...
ti.targets.elf.C66.rootDir ?= C:/ti/ccsv8/tools/compiler/ti-cgt-c6000_8.3.1
...
.dlls,e66 .dlls: app2.pe66

-include package/cfg/app2_pe66.mak
-include package/cfg/app2_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/app2_pe66.dep
endif
app2.pe66: package/cfg/app2_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
app2.pe66 package/cfg/app2_pe66.c: .libraries,e66
endif

package/cfg/app2_pe66.c package/cfg/app2_pe66.h package/cfg/app2_pe66.xdl: override _PROG_NAME := app2.xe66
package/cfg/app2_pe66.c: package/cfg/app2_pe66.cfg
package/cfg/app2_pe66.xdc.inc: package/cfg/app2_pe66.xdl
package/cfg/app2_pe66.xdl package/cfg/app2_pe66.c: .interfaces

clean:: clean,e66
	-$(RM) package/cfg/app2_pe66.cfg
	-$(RM) package/cfg/app2_pe66.dep
	-$(RM) package/cfg/app2_pe66.c
	-$(RM) package/cfg/app2_pe66.xdc.inc

clean,e66::
	-$(RM) app2.pe66
.executables,e66 .executables: app2.xe66

app2.xe66: |app2.pe66

-include package/cfg/app2.xe66.mak
app2.xe66: package/cfg/app2_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/app2_pe66.oe66   package/cfg/app2_pe66.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
app2.xe66: export C_DIR=
app2.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)
app2.xe66: Path:=$(ti.targets.elf.C66.rootDir)/bin/;$(PATH)

app2.test test,e66 test: app2.xe66.test

app2.xe66.test:: app2.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 app2.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.app2.xe66, ) 
endif
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
app2_pe66.oe66,copy : package/cfg/app2_pe66.oe66
app2_pe66.se66,copy : package/cfg/app2_pe66.se66
