...
typedef enum
{
    srio_Normal_mode = 0,            /**< Normal mode */
    srio_Loopback_mode  /** Loopback mode */
} srioWorkMode_e;
 ...
 */
#define FPGA0_SRIO_8BIT_DEVICE_ID          0x77
//#define FPGA1_SRIO___8BIT_DEVICE_ID    0xBE

/* Consumer Device Identifiers.
 */
#define DSP_SRIO_8BIT_DEVICE_ID             0xAD
#define DSP_SRIO_16BIT_DEVICE_ID            0xAD

#define DSP_SRIO_SECOND_8BIT_DEVICE_ID     0x77
