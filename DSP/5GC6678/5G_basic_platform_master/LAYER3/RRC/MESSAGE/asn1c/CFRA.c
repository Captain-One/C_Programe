...
static int
memb_totalNumberOfRA_Preambles_v1530_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_totalNumberOfRA_Preambles_v1530_constr_23 CC_NOTUSED = {
	{ 1, 1 }	/* (1..63) */,
	-1};
static asn_per_constraints_t asn_PER_memb_totalNumberOfRA_Preambles_v1530_constr_23 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_resources_13[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CFRA__resources, choice.ssb),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_ssb_14,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CFRA__resources, choice.csirs),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_csirs_18,
		0,
...
asn_TYPE_member_t asn_MBR_CFRA_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CFRA, totalNumberOfRA_Preambles_v1530),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_totalNumberOfRA_Preambles_v1530_constr_23, &asn_PER_memb_totalNumberOfRA_Preambles_v1530_constr_23,  memb_totalNumberOfRA_Preambles_v1530_constraint_1 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_CFRA_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* totalNumberOfRA-Preambles-v1530 */
};
