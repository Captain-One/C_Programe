...
static asn_TYPE_member_t asn_MBR_format_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_Resource__format, choice.format0),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_Resource__format, choice.format1),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_Resource__format, choice.format2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_Resource__format, choice.format3),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PUCCH_Resource__format, choice.format4),
