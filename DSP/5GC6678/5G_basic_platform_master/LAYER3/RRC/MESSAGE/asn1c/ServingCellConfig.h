...
typedef struct ServingCellConfig {
	...
	struct SetupRelease	*pdcch_ServingCellConfig	/* OPTIONAL */;
	struct SetupRelease	*pdsch_ServingCellConfig	/* OPTIONAL */;
	struct SetupRelease	*csi_MeasConfig	/* OPTIONAL */;
	 ...
	 */
	struct SetupRelease	*lte_CRS_ToMatchAround	/* OPTIONAL */;
...
extern asn_TYPE_member_t asn_MBR_ServingCellConfig_1[22];
