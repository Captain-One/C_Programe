...
static asn_TYPE_member_t asn_MBR_pusch_ProcessingType1_DifferentTB_PerSlot_21[] = {
	{ ATF_POINTER, 4, offsetof(struct FeatureSetUplink__pusch_ProcessingType1_DifferentTB_PerSlot, scs_15kHz),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 3, offsetof(struct FeatureSetUplink__pusch_ProcessingType1_DifferentTB_PerSlot, scs_30kHz),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct FeatureSetUplink__pusch_ProcessingType1_DifferentTB_PerSlot, scs_60kHz),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct FeatureSetUplink__pusch_ProcessingType1_DifferentTB_PerSlot, scs_120kHz),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_pusch_ProcessingType1_DifferentTB_PerSlot_oms_21[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_pusch_ProcessingType1_DifferentTB_PerSlot_tags_21[] = {
	(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_pusch_ProcessingType1_DifferentTB_PerSlot_tag2el_21[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_pusch_ProcessingType1_DifferentTB_PerSlot_specs_21 = {
	sizeof(struct FeatureSetUplink__pusch_ProcessingType1_DifferentTB_PerSlot),
	offsetof(struct FeatureSetUplink__pusch_ProcessingType1_DifferentTB_PerSlot, _asn_ctx),
	asn_MAP_pusch_ProcessingType1_DifferentTB_PerSlot_tag2el_21,
	4,	/* Count of tags in the map */
	asn_MAP_pusch_ProcessingType1_DifferentTB_PerSlot_oms_21,	/* Optional members */
	4, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_pusch_ProcessingType1_DifferentTB_PerSlot_21 = {
	"pusch-ProcessingType1-DifferentTB-PerSlot",
	"pusch-ProcessingType1-DifferentTB-PerSlot",
	&asn_OP_SEQUENCE,
	asn_DEF_pusch_ProcessingType1_DifferentTB_PerSlot_tags_21,
	sizeof(asn_DEF_pusch_ProcessingType1_DifferentTB_PerSlot_tags_21)
		/sizeof(asn_DEF_pusch_ProcessingType1_DifferentTB_PerSlot_tags_21[0]) - 1, /* 1 */
	asn_DEF_pusch_ProcessingType1_DifferentTB_PerSlot_tags_21,	/* Same as above */
	sizeof(asn_DEF_pusch_ProcessingType1_DifferentTB_PerSlot_tags_21)
		/sizeof(asn_DEF_pusch_ProcessingType1_DifferentTB_PerSlot_tags_21[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_pusch_ProcessingType1_DifferentTB_PerSlot_21,
	4,	/* Elements count */
	&asn_SPC_pusch_ProcessingType1_DifferentTB_PerSlot_specs_21	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_FeatureSetUplink_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct FeatureSetUplink, dummy1),
	...
	{ ATF_POINTER, 2, offsetof(struct FeatureSetUplink, pusch_ProcessingType1_DifferentTB_PerSlot),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_pusch_ProcessingType1_DifferentTB_PerSlot_21,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"pusch-ProcessingType1-DifferentTB-PerSlot"
		},
	{ ATF_POINTER, 1, offsetof(struct FeatureSetUplink, dummy2),
