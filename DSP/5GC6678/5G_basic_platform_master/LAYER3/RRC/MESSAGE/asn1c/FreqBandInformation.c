...
asn_TYPE_member_t asn_MBR_FreqBandInformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct FreqBandInformation, choice.bandInformationEUTRA),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct FreqBandInformation, choice.bandInformationNR),
