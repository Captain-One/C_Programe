...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UL_CCCH_MessageType__c1, choice.rrcSetupRequest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_CCCH_MessageType__c1, choice.rrcResumeRequest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_CCCH_MessageType__c1, choice.rrcReestablishmentRequest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_CCCH_MessageType__c1, choice.rrcSystemInfoRequest),
