...
static asn_TYPE_member_t asn_MBR_reportType_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ReportConfigInterRAT__reportType, choice.periodical),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ReportConfigInterRAT__reportType, choice.eventTriggered),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ReportConfigInterRAT__reportType, choice.reportCGI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ReportConfigInterRAT__reportType, choice.reportSFTD),
