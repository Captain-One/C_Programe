...
static asn_oer_constraints_t asn_OER_type_rateMatching_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_maxMIMO_Layers_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (1..4) */,
	-1};
static asn_per_constraints_t asn_PER_memb_maxMIMO_Layers_constr_10 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_rateMatching_3 = {
	...
	{ &asn_OER_type_rateMatching_constr_3, &asn_PER_type_rateMatching_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_PUSCH_ServingCellConfig_1[] = {
	{ ATF_POINTER, 5, offsetof(struct PUSCH_ServingCellConfig, codeBlockGroupTransmission),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_1076P44,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"codeBlockGroupTransmission"
		},
	{ ATF_POINTER, 4, offsetof(struct PUSCH_ServingCellConfig, rateMatching),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_POINTER, 3, offsetof(struct PUSCH_ServingCellConfig, xOverhead),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_xOverhead_5,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct PUSCH_ServingCellConfig, maxMIMO_Layers),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_maxMIMO_Layers_constr_10, &asn_PER_memb_maxMIMO_Layers_constr_10,  memb_maxMIMO_Layers_constraint_1 },
		0, 0, /* No default value */
		"maxMIMO-Layers"
		},
	{ ATF_POINTER, 1, offsetof(struct PUSCH_ServingCellConfig, processingType2Enabled),
...
static const int asn_MAP_PUSCH_ServingCellConfig_oms_1[] = { 0, 1, 2, 3, 4 };
