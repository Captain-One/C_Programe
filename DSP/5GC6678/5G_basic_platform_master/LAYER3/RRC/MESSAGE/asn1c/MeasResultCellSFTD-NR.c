...
asn_TYPE_member_t asn_MBR_MeasResultCellSFTD_NR_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultCellSFTD_NR, physCellId),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultCellSFTD_NR, sfn_OffsetResult),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeasResultCellSFTD_NR, frameBoundaryOffsetResult),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasResultCellSFTD_NR, rsrp_Result),
...
static const int asn_MAP_MeasResultCellSFTD_NR_oms_1[] = { 3 };
static const ber_tlv_tag_t asn_DEF_MeasResultCellSFTD_NR_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_MeasResultCellSFTD_NR_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_MeasResultCellSFTD_NR_specs_1 = {
	sizeof(struct MeasResultCellSFTD_NR),
	offsetof(struct MeasResultCellSFTD_NR, _asn_ctx),
	asn_MAP_MeasResultCellSFTD_NR_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_MeasResultCellSFTD_NR_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_MeasResultCellSFTD_NR = {
	"MeasResultCellSFTD-NR",
	"MeasResultCellSFTD-NR",
	&asn_OP_SEQUENCE,
	asn_DEF_MeasResultCellSFTD_NR_tags_1,
	sizeof(asn_DEF_MeasResultCellSFTD_NR_tags_1)
		/sizeof(asn_DEF_MeasResultCellSFTD_NR_tags_1[0]), /* 1 */
	asn_DEF_MeasResultCellSFTD_NR_tags_1,	/* Same as above */
	sizeof(asn_DEF_MeasResultCellSFTD_NR_tags_1)
		/sizeof(asn_DEF_MeasResultCellSFTD_NR_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_MeasResultCellSFTD_NR_1,
	4,	/* Elements count */
	&asn_SPC_MeasResultCellSFTD_NR_specs_1	/* Additional specs */
};
