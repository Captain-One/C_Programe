...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct FailureInformation__criticalExtensions, choice.failureInformation),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct FailureInformation__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
