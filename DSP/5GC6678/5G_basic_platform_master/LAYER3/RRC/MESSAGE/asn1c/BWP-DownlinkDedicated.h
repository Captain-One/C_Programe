...
typedef struct BWP_DownlinkDedicated {
	struct SetupRelease	*pdcch_Config	/* OPTIONAL */;
	struct SetupRelease	*pdsch_Config	/* OPTIONAL */;
	struct SetupRelease	*sps_Config	/* OPTIONAL */;
	struct SetupRelease	*radioLinkMonitoringConfig	/* OPTIONAL */;
	/*
