...
static int
memb_csi_SSB_ResourceSetToReleaseList_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	size_t size;
...
static asn_oer_constraints_t asn_OER_type_csi_SSB_ResourceSetToReleaseList_constr_20 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
static asn_per_constraints_t asn_PER_type_csi_SSB_ResourceSetToReleaseList_constr_20 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
...
static asn_oer_constraints_t asn_OER_memb_csi_SSB_ResourceSetToReleaseList_constr_20 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
static asn_per_constraints_t asn_PER_memb_csi_SSB_ResourceSetToReleaseList_constr_20 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (SIZE(1..64)) */,
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_csi_SSB_ResourceSetToReleaseList_20[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (2 << 2)),
		0,
...
static const ber_tlv_tag_t asn_DEF_csi_SSB_ResourceSetToReleaseList_tags_20[] = {
	(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_csi_SSB_ResourceSetToReleaseList_specs_20 = {
	sizeof(struct CSI_MeasConfig__csi_SSB_ResourceSetToReleaseList),
	offsetof(struct CSI_MeasConfig__csi_SSB_ResourceSetToReleaseList, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_csi_SSB_ResourceSetToReleaseList_20 = {
	"csi-SSB-ResourceSetToReleaseList",
	"csi-SSB-ResourceSetToReleaseList",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_csi_SSB_ResourceSetToReleaseList_tags_20,
	sizeof(asn_DEF_csi_SSB_ResourceSetToReleaseList_tags_20)
		/sizeof(asn_DEF_csi_SSB_ResourceSetToReleaseList_tags_20[0]) - 1, /* 1 */
	asn_DEF_csi_SSB_ResourceSetToReleaseList_tags_20,	/* Same as above */
	sizeof(asn_DEF_csi_SSB_ResourceSetToReleaseList_tags_20)
		/sizeof(asn_DEF_csi_SSB_ResourceSetToReleaseList_tags_20[0]), /* 2 */
	{ &asn_OER_type_csi_SSB_ResourceSetToReleaseList_constr_20, &asn_PER_type_csi_SSB_ResourceSetToReleaseList_constr_20, SEQUENCE_OF_constraint },
	asn_MBR_csi_SSB_ResourceSetToReleaseList_20,
	1,	/* Single element */
	&asn_SPC_csi_SSB_ResourceSetToReleaseList_specs_20	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_CSI_MeasConfig_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct CSI_MeasConfig, csi_SSB_ResourceSetToReleaseList),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_csi_SSB_ResourceSetToReleaseList_20,
		0,
		{ &asn_OER_memb_csi_SSB_ResourceSetToReleaseList_constr_20, &asn_PER_memb_csi_SSB_ResourceSetToReleaseList_constr_20,  memb_csi_SSB_ResourceSetToReleaseList_constraint_1 },
		0, 0, /* No default value */
		"csi-SSB-ResourceSetToReleaseList"
		},
