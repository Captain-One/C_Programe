...
asn_TYPE_member_t asn_MBR_FeatureSets_1[] = {
	{ ATF_POINTER, 7, offsetof(struct FeatureSets, featureSetsDownlink),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct FeatureSets, featureSetsDownlinkPerCC),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct FeatureSets, featureSetsUplink),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct FeatureSets, featureSetsUplinkPerCC),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct FeatureSets, featureSetsDownlink_v1540),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct FeatureSets, featureSetsUplink_v1540),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct FeatureSets, featureSetsUplinkPerCC_v1540),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
...
static const int asn_MAP_FeatureSets_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };
