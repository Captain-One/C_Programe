...
asn_TYPE_member_t asn_MBR_RF_Parameters_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct RF_Parameters, supportedBandCombinationList),
	...
	{ ATF_POINTER, 5, offsetof(struct RF_Parameters, appliedFreqBandListFilter),
	...
	{ ATF_POINTER, 4, offsetof(struct RF_Parameters, supportedBandCombinationList_v1540),
	...
	{ ATF_POINTER, 3, offsetof(struct RF_Parameters, srs_SwitchingTimeRequested),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct RF_Parameters, supportedBandCombinationList_v1550),
	...
	{ ATF_POINTER, 1, offsetof(struct RF_Parameters, supportedBandCombinationList_v1560),
...
static const int asn_MAP_RF_Parameters_oms_1[] = { 1, 2, 3, 4, 5, 6 };
