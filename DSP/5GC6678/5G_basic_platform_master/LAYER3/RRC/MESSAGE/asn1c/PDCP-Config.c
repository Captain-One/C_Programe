...
static asn_oer_constraints_t asn_OER_type_cipheringDisabled_constr_127 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_cipheringDisabled_constr_127 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_TYPE_member_t asn_MBR_headerCompression_26[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PDCP_Config__drb__headerCompression, choice.rohc),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_rohc_28,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PDCP_Config__drb__headerCompression, choice.uplinkOnlyROHC),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static const asn_INTEGER_enum_map_t asn_MAP_cipheringDisabled_value2enum_127[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_cipheringDisabled_enum2value_127[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_cipheringDisabled_specs_127 = {
	asn_MAP_cipheringDisabled_value2enum_127,	/* "tag" => N; sorted by tag */
	asn_MAP_cipheringDisabled_enum2value_127,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_cipheringDisabled_tags_127[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_cipheringDisabled_127 = {
	"cipheringDisabled",
	"cipheringDisabled",
	&asn_OP_NativeEnumerated,
	asn_DEF_cipheringDisabled_tags_127,
	sizeof(asn_DEF_cipheringDisabled_tags_127)
		/sizeof(asn_DEF_cipheringDisabled_tags_127[0]) - 1, /* 1 */
	asn_DEF_cipheringDisabled_tags_127,	/* Same as above */
	sizeof(asn_DEF_cipheringDisabled_tags_127)
		/sizeof(asn_DEF_cipheringDisabled_tags_127[0]), /* 2 */
	{ &asn_OER_type_cipheringDisabled_constr_127, &asn_PER_type_cipheringDisabled_constr_127, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_cipheringDisabled_specs_127	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_PDCP_Config_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PDCP_Config, cipheringDisabled),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_cipheringDisabled_127,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"cipheringDisabled"
