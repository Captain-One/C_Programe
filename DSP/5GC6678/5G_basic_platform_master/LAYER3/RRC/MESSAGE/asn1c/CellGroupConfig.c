...
static asn_oer_constraints_t asn_OER_type_reportUplinkTxDirectCurrent_v1530_constr_15 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_reportUplinkTxDirectCurrent_v1530_constr_15 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_reportUplinkTxDirectCurrent_v1530_value2enum_15[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_reportUplinkTxDirectCurrent_v1530_enum2value_15[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_reportUplinkTxDirectCurrent_v1530_specs_15 = {
	asn_MAP_reportUplinkTxDirectCurrent_v1530_value2enum_15,	/* "tag" => N; sorted by tag */
	asn_MAP_reportUplinkTxDirectCurrent_v1530_enum2value_15,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_reportUplinkTxDirectCurrent_v1530_tags_15[] = {
	(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_reportUplinkTxDirectCurrent_v1530_15 = {
	"reportUplinkTxDirectCurrent-v1530",
	"reportUplinkTxDirectCurrent-v1530",
	&asn_OP_NativeEnumerated,
	asn_DEF_reportUplinkTxDirectCurrent_v1530_tags_15,
	sizeof(asn_DEF_reportUplinkTxDirectCurrent_v1530_tags_15)
		/sizeof(asn_DEF_reportUplinkTxDirectCurrent_v1530_tags_15[0]) - 1, /* 1 */
	asn_DEF_reportUplinkTxDirectCurrent_v1530_tags_15,	/* Same as above */
	sizeof(asn_DEF_reportUplinkTxDirectCurrent_v1530_tags_15)
		/sizeof(asn_DEF_reportUplinkTxDirectCurrent_v1530_tags_15[0]), /* 2 */
	{ &asn_OER_type_reportUplinkTxDirectCurrent_v1530_constr_15, &asn_PER_type_reportUplinkTxDirectCurrent_v1530_constr_15, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_reportUplinkTxDirectCurrent_v1530_specs_15	/* Additional specs */
};
...
static asn_TYPE_member_t asn_MBR_CellGroupConfig_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CellGroupConfig, reportUplinkTxDirectCurrent_v1530),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_reportUplinkTxDirectCurrent_v1530_15,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"reportUplinkTxDirectCurrent-v1530"
...
static const asn_TYPE_tag2member_t asn_MAP_CellGroupConfig_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 } /* reportUplinkTxDirectCurrent-v1530 */
};
