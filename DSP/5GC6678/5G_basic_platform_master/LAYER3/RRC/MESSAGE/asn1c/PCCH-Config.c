...
static asn_TYPE_member_t asn_MBR_firstPDCCH_MonitoringOccasionOfPO_13[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO, choice.sCS15KHZoneT),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO, choice.sCS30KHZoneT_SCS15KHZhalfT),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO, choice.sCS60KHZoneT_SCS30KHZhalfT_SCS15KHZquarterT),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO, choice.sCS120KHZoneT_SCS60KHZhalfT_SCS30KHZquarterT_SCS15KHZoneEighthT),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO, choice.sCS120KHZhalfT_SCS60KHZquarterT_SCS30KHZoneEighthT_SCS15KHZoneSixteenthT),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO, choice.sCS120KHZquarterT_SCS60KHZoneEighthT_SCS30KHZoneSixteenthT),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO, choice.sCS120KHZoneEighthT_SCS60KHZoneSixteenthT),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PCCH_Config__firstPDCCH_MonitoringOccasionOfPO, choice.sCS120KHZoneSixteenthT),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
