...
static asn_oer_constraints_t asn_OER_memb_ss_PBCH_BlockPower_constr_33 CC_NOTUSED = {
	{ 1, 0 }	/* (-60..50) */,
	-1};
static asn_per_constraints_t asn_PER_memb_ss_PBCH_BlockPower_constr_33 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_ServingCellConfigCommon_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ServingCellConfigCommon, ss_PBCH_BlockPower),
		...
		0,
		{ &asn_OER_memb_ss_PBCH_BlockPower_constr_33, &asn_PER_memb_ss_PBCH_BlockPower_constr_33,  memb_ss_PBCH_BlockPower_constraint_1 },
		0, 0, /* No default value */
		"ss-PBCH-BlockPower"
		},
};
