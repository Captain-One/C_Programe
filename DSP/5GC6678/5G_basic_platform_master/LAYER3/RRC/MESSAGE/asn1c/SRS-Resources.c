...
static int
memb_maxNumberSemiPersistentSRS_PerBWP_PerSlot_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_type_maxNumberSemiPersistentSRS_PerBWP_constr_16 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_maxNumberSemiPersistentSRS_PerBWP_constr_16 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  4 }	/* (0..4) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static asn_oer_constraints_t asn_OER_memb_maxNumberSemiPersistentSRS_PerBWP_PerSlot_constr_22 CC_NOTUSED = {
	{ 1, 1 }	/* (1..6) */,
	-1};
static asn_per_constraints_t asn_PER_memb_maxNumberSemiPersistentSRS_PerBWP_PerSlot_constr_22 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  1,  6 }	/* (1..6) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_maxNumberSemiPersistentSRS_PerBWP_value2enum_16[] = {
	{ 0,	2,	"n1" },
	{ 1,	2,	"n2" },
	{ 2,	2,	"n4" },
	{ 3,	2,	"n8" },
...
static const unsigned int asn_MAP_maxNumberSemiPersistentSRS_PerBWP_enum2value_16[] = {
	0,	/* n1(0) */
	4,	/* n16(4) */
	1,	/* n2(1) */
	2,	/* n4(2) */
...
static const asn_INTEGER_specifics_t asn_SPC_maxNumberSemiPersistentSRS_PerBWP_specs_16 = {
	asn_MAP_maxNumberSemiPersistentSRS_PerBWP_value2enum_16,	/* "tag" => N; sorted by tag */
	asn_MAP_maxNumberSemiPersistentSRS_PerBWP_enum2value_16,	/* N => "tag"; sorted by N */
	5,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_maxNumberSemiPersistentSRS_PerBWP_tags_16[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_maxNumberSemiPersistentSRS_PerBWP_16 = {
	"maxNumberSemiPersistentSRS-PerBWP",
	"maxNumberSemiPersistentSRS-PerBWP",
	&asn_OP_NativeEnumerated,
	asn_DEF_maxNumberSemiPersistentSRS_PerBWP_tags_16,
	sizeof(asn_DEF_maxNumberSemiPersistentSRS_PerBWP_tags_16)
		/sizeof(asn_DEF_maxNumberSemiPersistentSRS_PerBWP_tags_16[0]) - 1, /* 1 */
	asn_DEF_maxNumberSemiPersistentSRS_PerBWP_tags_16,	/* Same as above */
	sizeof(asn_DEF_maxNumberSemiPersistentSRS_PerBWP_tags_16)
		/sizeof(asn_DEF_maxNumberSemiPersistentSRS_PerBWP_tags_16[0]), /* 2 */
	{ &asn_OER_type_maxNumberSemiPersistentSRS_PerBWP_constr_16, &asn_PER_type_maxNumberSemiPersistentSRS_PerBWP_constr_16, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_maxNumberSemiPersistentSRS_PerBWP_specs_16	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_SRS_Resources_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resources, maxNumberSemiPersistentSRS_PerBWP),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_maxNumberSemiPersistentSRS_PerBWP_16,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"maxNumberSemiPersistentSRS-PerBWP"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_Resources, maxNumberSemiPersistentSRS_PerBWP_PerSlot),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_maxNumberSemiPersistentSRS_PerBWP_PerSlot_constr_22, &asn_PER_memb_maxNumberSemiPersistentSRS_PerBWP_PerSlot_constr_22,  memb_maxNumberSemiPersistentSRS_PerBWP_PerSlot_constraint_1 },
		0, 0, /* No default value */
