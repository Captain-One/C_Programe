...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCReject__criticalExtensions, choice.rrcReject),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCReject__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
