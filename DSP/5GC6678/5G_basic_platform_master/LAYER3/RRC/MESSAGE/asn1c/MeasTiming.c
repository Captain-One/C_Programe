...
asn_TYPE_member_t asn_MBR_MeasTiming_1[] = {
	{ ATF_POINTER, 3, offsetof(struct MeasTiming, frequencyAndTiming),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct MeasTiming, ssb_ToMeasure_v1540),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasTiming, physCellId),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PhysCellId,
		0,
...
static const int asn_MAP_MeasTiming_oms_1[] = { 0, 1, 2 };
...
static const asn_TYPE_tag2member_t asn_MAP_MeasTiming_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* ssb-ToMeasure-v1540 */
