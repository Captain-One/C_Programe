...
static asn_oer_constraints_t asn_OER_type_diffNumerologyWithinPUCCH_GroupSmallerSCS_constr_14 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_diffNumerologyWithinPUCCH_GroupSmallerSCS_constr_14 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_diffNumerologyWithinPUCCH_GroupSmallerSCS_value2enum_14[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_diffNumerologyWithinPUCCH_GroupSmallerSCS_enum2value_14[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_diffNumerologyWithinPUCCH_GroupSmallerSCS_specs_14 = {
	asn_MAP_diffNumerologyWithinPUCCH_GroupSmallerSCS_value2enum_14,	/* "tag" => N; sorted by tag */
	asn_MAP_diffNumerologyWithinPUCCH_GroupSmallerSCS_enum2value_14,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_diffNumerologyWithinPUCCH_GroupSmallerSCS_tags_14[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_diffNumerologyWithinPUCCH_GroupSmallerSCS_14 = {
	"diffNumerologyWithinPUCCH-GroupSmallerSCS",
	"diffNumerologyWithinPUCCH-GroupSmallerSCS",
	&asn_OP_NativeEnumerated,
	asn_DEF_diffNumerologyWithinPUCCH_GroupSmallerSCS_tags_14,
	sizeof(asn_DEF_diffNumerologyWithinPUCCH_GroupSmallerSCS_tags_14)
		/sizeof(asn_DEF_diffNumerologyWithinPUCCH_GroupSmallerSCS_tags_14[0]) - 1, /* 1 */
	asn_DEF_diffNumerologyWithinPUCCH_GroupSmallerSCS_tags_14,	/* Same as above */
	sizeof(asn_DEF_diffNumerologyWithinPUCCH_GroupSmallerSCS_tags_14)
		/sizeof(asn_DEF_diffNumerologyWithinPUCCH_GroupSmallerSCS_tags_14[0]), /* 2 */
	{ &asn_OER_type_diffNumerologyWithinPUCCH_GroupSmallerSCS_constr_14, &asn_PER_type_diffNumerologyWithinPUCCH_GroupSmallerSCS_constr_14, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_diffNumerologyWithinPUCCH_GroupSmallerSCS_specs_14	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_CA_ParametersNR_1[] = {
	{ ATF_POINTER, 8, offsetof(struct CA_ParametersNR, dummy),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 2, offsetof(struct CA_ParametersNR, diffNumerologyWithinPUCCH_GroupSmallerSCS),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_diffNumerologyWithinPUCCH_GroupSmallerSCS_14,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"diffNumerologyWithinPUCCH-GroupSmallerSCS"
