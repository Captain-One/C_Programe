...
static asn_oer_constraints_t asn_OER_type_v2x_EUTRA_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_v2x_EUTRA_8 = {
	...
	{ &asn_OER_type_v2x_EUTRA_constr_8, &asn_PER_type_v2x_EUTRA_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
