...
asn_TYPE_member_t asn_MBR_RRM_Config_1[] = {
	{ ATF_POINTER, 3, offsetof(struct RRM_Config, ue_InactiveTime),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 2, offsetof(struct RRM_Config, candidateCellInfoList),
	...
	{ ATF_POINTER, 1, offsetof(struct RRM_Config, candidateCellInfoListSN_EUTRA),
...
static const int asn_MAP_RRM_Config_oms_1[] = { 0, 1, 2 };
