...
typedef struct BWP_UplinkDedicated {
	struct SetupRelease	*pucch_Config	/* OPTIONAL */;
	struct SetupRelease	*pusch_Config	/* OPTIONAL */;
	struct SetupRelease	*configuredGrantConfig	/* OPTIONAL */;
	struct SetupRelease	*srs_Config	/* OPTIONAL */;
	struct SetupRelease	*beamFailureRecoveryConfig	/* OPTIONAL */;
	/*
