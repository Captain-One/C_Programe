...
asn_TYPE_member_t asn_MBR_DummyI_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DummyI, supportedSRS_TxPortSwitch),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct DummyI, txSwitchImpactToRx),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_DummyI_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_DummyI_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DummyI_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* supportedSRS-TxPortSwitch */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* txSwitchImpactToRx */
};
asn_SEQUENCE_specifics_t asn_SPC_DummyI_specs_1 = {
	sizeof(struct DummyI),
	offsetof(struct DummyI, _asn_ctx),
	asn_MAP_DummyI_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_DummyI_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_DummyI = {
	"DummyI",
	"DummyI",
	&asn_OP_SEQUENCE,
	asn_DEF_DummyI_tags_1,
	sizeof(asn_DEF_DummyI_tags_1)
		/sizeof(asn_DEF_DummyI_tags_1[0]), /* 1 */
	asn_DEF_DummyI_tags_1,	/* Same as above */
	sizeof(asn_DEF_DummyI_tags_1)
		/sizeof(asn_DEF_DummyI_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_DummyI_1,
	2,	/* Elements count */
	&asn_SPC_DummyI_specs_1	/* Additional specs */
};
