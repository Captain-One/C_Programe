...
static asn_TYPE_member_t asn_MBR_srs_CarrierSwitch_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct BandParameters_v1540__srs_CarrierSwitch, choice.nr),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_nr_3,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct BandParameters_v1540__srs_CarrierSwitch, choice.eutra),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_eutra_6,
		0,
