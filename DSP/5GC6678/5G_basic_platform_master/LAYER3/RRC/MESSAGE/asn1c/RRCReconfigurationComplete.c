...
static asn_TYPE_member_t asn_MBR_criticalExtensions_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCReconfigurationComplete__criticalExtensions, choice.rrcReconfigurationComplete),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCReconfigurationComplete__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
