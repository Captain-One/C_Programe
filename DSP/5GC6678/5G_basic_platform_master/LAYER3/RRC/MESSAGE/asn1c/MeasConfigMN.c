...
static asn_oer_constraints_t asn_OER_type_gapPurpose_constr_5 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_gapPurpose_constr_5 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_gapPurpose_value2enum_5[] = {
	{ 0,	5,	"perUE" },
	{ 1,	6,	"perFR1" }
};
static const unsigned int asn_MAP_gapPurpose_enum2value_5[] = {
	1,	/* perFR1(1) */
	0	/* perUE(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_gapPurpose_specs_5 = {
	asn_MAP_gapPurpose_value2enum_5,	/* "tag" => N; sorted by tag */
	asn_MAP_gapPurpose_enum2value_5,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_gapPurpose_tags_5[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_gapPurpose_5 = {
	"gapPurpose",
	"gapPurpose",
	&asn_OP_NativeEnumerated,
	asn_DEF_gapPurpose_tags_5,
	sizeof(asn_DEF_gapPurpose_tags_5)
		/sizeof(asn_DEF_gapPurpose_tags_5[0]) - 1, /* 1 */
	asn_DEF_gapPurpose_tags_5,	/* Same as above */
	sizeof(asn_DEF_gapPurpose_tags_5)
		/sizeof(asn_DEF_gapPurpose_tags_5[0]), /* 2 */
	{ &asn_OER_type_gapPurpose_constr_5, &asn_PER_type_gapPurpose_constr_5, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_gapPurpose_specs_5	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_MeasConfigMN_1[] = {
	{ ATF_POINTER, 4, offsetof(struct MeasConfigMN, measuredFrequenciesMN),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct MeasConfigMN, measGapConfig),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_1076P52,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"measGapConfig"
		},
	{ ATF_POINTER, 2, offsetof(struct MeasConfigMN, gapPurpose),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_gapPurpose_5,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"gapPurpose"
		},
	{ ATF_POINTER, 1, offsetof(struct MeasConfigMN, measGapConfigFR2),
...
static const int asn_MAP_MeasConfigMN_oms_1[] = { 0, 1, 2, 3 };
