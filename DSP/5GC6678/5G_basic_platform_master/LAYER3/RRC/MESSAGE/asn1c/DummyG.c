...
static asn_oer_constraints_t asn_OER_type_maxNumberSSB_CSI_RS_ResourceTwoTx_constr_7 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_supportedCSI_RS_Density_constr_14 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_maxNumberSSB_CSI_RS_ResourceTwoTx_7 = {
	...
	{ &asn_OER_type_maxNumberSSB_CSI_RS_ResourceTwoTx_constr_7, &asn_PER_type_maxNumberSSB_CSI_RS_ResourceTwoTx_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_supportedCSI_RS_Density_14 = {
	...
	{ &asn_OER_type_supportedCSI_RS_Density_constr_14, &asn_PER_type_supportedCSI_RS_Density_constr_14, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_supportedCSI_RS_Density_specs_14	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_DummyG_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DummyG, maxNumberSSB_CSI_RS_ResourceOneTx),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyG, maxNumberSSB_CSI_RS_ResourceTwoTx),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyG, supportedCSI_RS_Density),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const ber_tlv_tag_t asn_DEF_DummyG_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DummyG_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_DummyG_specs_1 = {
	sizeof(struct DummyG),
	offsetof(struct DummyG, _asn_ctx),
	asn_MAP_DummyG_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_DummyG = {
	"DummyG",
	"DummyG",
	&asn_OP_SEQUENCE,
	asn_DEF_DummyG_tags_1,
	sizeof(asn_DEF_DummyG_tags_1)
		/sizeof(asn_DEF_DummyG_tags_1[0]), /* 1 */
	asn_DEF_DummyG_tags_1,	/* Same as above */
	sizeof(asn_DEF_DummyG_tags_1)
		/sizeof(asn_DEF_DummyG_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_DummyG_1,
	3,	/* Elements count */
	&asn_SPC_DummyG_specs_1	/* Additional specs */
};
