	...
	struct SRS_ResourceSet__resourceType {
		...
		union SRS_ResourceSet__resourceType_u {
			struct SRS_ResourceSet__resourceType__aperiodic {
				 ...
				 */
				struct SRS_ResourceSet__resourceType__aperiodic__aperiodicSRS_ResourceTriggerList_v1530 {
...
/* extern asn_TYPE_descriptor_t asn_DEF_srs_PowerControlAdjustmentStates_29;	// (Use -fall-defs-global to expose) */
