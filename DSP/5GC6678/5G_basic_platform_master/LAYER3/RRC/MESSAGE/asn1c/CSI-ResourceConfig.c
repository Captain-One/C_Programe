...
static asn_TYPE_member_t asn_MBR_csi_RS_ResourceSetList_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_ResourceConfig__csi_RS_ResourceSetList, choice.nzp_CSI_RS_SSB),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CSI_ResourceConfig__csi_RS_ResourceSetList, choice.csi_IM_ResourceSetList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
