...
static asn_TYPE_member_t asn_MBR_eventId_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EventTriggerConfig__eventId, choice.eventA1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_eventA1_3,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EventTriggerConfig__eventId, choice.eventA2),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_eventA2_8,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EventTriggerConfig__eventId, choice.eventA3),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_eventA3_13,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EventTriggerConfig__eventId, choice.eventA4),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_eventA4_19,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EventTriggerConfig__eventId, choice.eventA5),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_eventA5_25,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EventTriggerConfig__eventId, choice.eventA6),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_eventA6_32,
		0,
