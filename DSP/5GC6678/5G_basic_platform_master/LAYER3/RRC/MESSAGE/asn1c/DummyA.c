...
asn_TYPE_member_t asn_MBR_DummyA_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DummyA, maxNumberNZP_CSI_RS_PerCC),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyA, maxNumberPortsAcrossNZP_CSI_RS_PerCC),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyA, maxNumberCS_IM_PerCC),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyA, maxNumberSimultaneousCSI_RS_ActBWP_AllCC),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyA, totalNumberPortsSimultaneousCSI_RS_ActBWP_AllCC),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const ber_tlv_tag_t asn_DEF_DummyA_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DummyA_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_DummyA_specs_1 = {
	sizeof(struct DummyA),
	offsetof(struct DummyA, _asn_ctx),
	asn_MAP_DummyA_tag2el_1,
	5,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_DummyA = {
	"DummyA",
	"DummyA",
	&asn_OP_SEQUENCE,
	asn_DEF_DummyA_tags_1,
	sizeof(asn_DEF_DummyA_tags_1)
		/sizeof(asn_DEF_DummyA_tags_1[0]), /* 1 */
	asn_DEF_DummyA_tags_1,	/* Same as above */
	sizeof(asn_DEF_DummyA_tags_1)
		/sizeof(asn_DEF_DummyA_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_DummyA_1,
	5,	/* Elements count */
	&asn_SPC_DummyA_specs_1	/* Additional specs */
};
