...
typedef struct PDSCH_Config {
	...
	struct SetupRelease	*dmrs_DownlinkForPDSCH_MappingTypeA	/* OPTIONAL */;
	struct SetupRelease	*dmrs_DownlinkForPDSCH_MappingTypeB	/* OPTIONAL */;
	...
	struct SetupRelease	*pdsch_TimeDomainAllocationList	/* OPTIONAL */;
	...
	struct SetupRelease	*p_ZP_CSI_RS_ResourceSet	/* OPTIONAL */;
	/*
