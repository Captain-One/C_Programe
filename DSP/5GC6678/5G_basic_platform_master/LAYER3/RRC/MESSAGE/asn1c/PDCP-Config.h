...
typedef enum PDCP_Config__cipheringDisabled {
	PDCP_Config__cipheringDisabled_true	= 0
} e_PDCP_Config__cipheringDisabled;
...
/* extern asn_TYPE_descriptor_t asn_DEF_cipheringDisabled_127;	// (Use -fall-defs-global to expose) */
