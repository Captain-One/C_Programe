...
static int
memb_ue_CapabilityEnquiryExt_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_ue_CapabilityEnquiryExt_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
static asn_per_constraints_t asn_PER_memb_ue_CapabilityEnquiryExt_constr_4 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_UECapabilityEnquiry_IEs_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct UECapabilityEnquiry_IEs, ue_CapabilityEnquiryExt),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
		{ &asn_OER_memb_ue_CapabilityEnquiryExt_constr_4, &asn_PER_memb_ue_CapabilityEnquiryExt_constr_4,  memb_ue_CapabilityEnquiryExt_constraint_1 },
		0, 0, /* No default value */
