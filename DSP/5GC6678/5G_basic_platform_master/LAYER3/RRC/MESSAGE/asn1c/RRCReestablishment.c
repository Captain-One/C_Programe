...
static asn_TYPE_member_t asn_MBR_criticalExtensions_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct RRCReestablishment__criticalExtensions, choice.rrcReestablishment),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCReestablishment__criticalExtensions, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
