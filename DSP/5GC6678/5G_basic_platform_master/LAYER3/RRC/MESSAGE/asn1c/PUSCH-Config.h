...
typedef struct PUSCH_Config {
	...
	struct SetupRelease	*dmrs_UplinkForPUSCH_MappingTypeA	/* OPTIONAL */;
	struct SetupRelease	*dmrs_UplinkForPUSCH_MappingTypeB	/* OPTIONAL */;
	...
	struct SetupRelease	*pusch_TimeDomainAllocationList	/* OPTIONAL */;
	...
	struct SetupRelease	*uci_OnPUSCH	/* OPTIONAL */;
