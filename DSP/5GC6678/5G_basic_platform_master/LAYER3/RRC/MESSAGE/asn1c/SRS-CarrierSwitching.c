...
static asn_TYPE_member_t asn_MBR_srs_TPC_PDCCH_Group_6[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_CarrierSwitching__srs_TPC_PDCCH_Group, choice.typeA),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_typeA_7,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SRS_CarrierSwitching__srs_TPC_PDCCH_Group, choice.typeB),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
