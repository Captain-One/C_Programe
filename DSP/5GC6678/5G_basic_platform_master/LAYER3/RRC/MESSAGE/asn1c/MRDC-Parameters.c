...
static asn_oer_constraints_t asn_OER_type_intraBandENDC_Support_v1540_constr_22 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_intraBandENDC_Support_v1540_constr_22 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_intraBandENDC_Support_v1540_value2enum_22[] = {
	{ 0,	14,	"non-contiguous" },
	{ 1,	4,	"both" }
};
static const unsigned int asn_MAP_intraBandENDC_Support_v1540_enum2value_22[] = {
	1,	/* both(1) */
	0	/* non-contiguous(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_intraBandENDC_Support_v1540_specs_22 = {
	asn_MAP_intraBandENDC_Support_v1540_value2enum_22,	/* "tag" => N; sorted by tag */
	asn_MAP_intraBandENDC_Support_v1540_enum2value_22,	/* N => "tag"; sorted by N */
	2,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_intraBandENDC_Support_v1540_tags_22[] = {
	(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_intraBandENDC_Support_v1540_22 = {
	"intraBandENDC-Support-v1540",
	"intraBandENDC-Support-v1540",
	&asn_OP_NativeEnumerated,
	asn_DEF_intraBandENDC_Support_v1540_tags_22,
	sizeof(asn_DEF_intraBandENDC_Support_v1540_tags_22)
		/sizeof(asn_DEF_intraBandENDC_Support_v1540_tags_22[0]) - 1, /* 1 */
	asn_DEF_intraBandENDC_Support_v1540_tags_22,	/* Same as above */
	sizeof(asn_DEF_intraBandENDC_Support_v1540_tags_22)
		/sizeof(asn_DEF_intraBandENDC_Support_v1540_tags_22[0]), /* 2 */
	{ &asn_OER_type_intraBandENDC_Support_v1540_constr_22, &asn_PER_type_intraBandENDC_Support_v1540_constr_22, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_intraBandENDC_Support_v1540_specs_22	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_MRDC_Parameters_1[] = {
	...
	{ ATF_POINTER, 9, offsetof(struct MRDC_Parameters, dynamicPowerSharing),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct MRDC_Parameters, intraBandENDC_Support_v1540),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_intraBandENDC_Support_v1540_22,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"intraBandENDC-Support-v1540"
...
static const asn_TYPE_tag2member_t asn_MAP_MRDC_Parameters_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (8 << 2)), 8, 0, 0 }, /* intraBandENDC-Support-v1540 */
