...
static asn_oer_constraints_t asn_OER_type_measCycleSCell_v1530_constr_24 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_measCycleSCell_v1530_constr_24 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_measCycleSCell_v1530_value2enum_24[] = {
	{ 0,	5,	"sf160" },
	{ 1,	5,	"sf256" },
	{ 2,	5,	"sf320" },
	{ 3,	5,	"sf512" },
...
static const unsigned int asn_MAP_measCycleSCell_v1530_enum2value_24[] = {
	5,	/* sf1024(5) */
	6,	/* sf1280(6) */
	0,	/* sf160(0) */
	1,	/* sf256(1) */
...
static const asn_INTEGER_specifics_t asn_SPC_measCycleSCell_v1530_specs_24 = {
	asn_MAP_measCycleSCell_v1530_value2enum_24,	/* "tag" => N; sorted by tag */
	asn_MAP_measCycleSCell_v1530_enum2value_24,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_measCycleSCell_v1530_tags_24[] = {
	(ASN_TAG_CLASS_CONTEXT | (19 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_measCycleSCell_v1530_24 = {
	"measCycleSCell-v1530",
	"measCycleSCell-v1530",
	&asn_OP_NativeEnumerated,
	asn_DEF_measCycleSCell_v1530_tags_24,
	sizeof(asn_DEF_measCycleSCell_v1530_tags_24)
		/sizeof(asn_DEF_measCycleSCell_v1530_tags_24[0]) - 1, /* 1 */
	asn_DEF_measCycleSCell_v1530_tags_24,	/* Same as above */
	sizeof(asn_DEF_measCycleSCell_v1530_tags_24)
		/sizeof(asn_DEF_measCycleSCell_v1530_tags_24[0]), /* 2 */
	{ &asn_OER_type_measCycleSCell_v1530_constr_24, &asn_PER_type_measCycleSCell_v1530_constr_24, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_measCycleSCell_v1530_specs_24	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_MeasObjectNR_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct MeasObjectNR, cellsToRemoveList),
	...
	{ ATF_POINTER, 7, offsetof(struct MeasObjectNR, cellsToAddModList),
	...
	{ ATF_POINTER, 6, offsetof(struct MeasObjectNR, blackCellsToRemoveList),
	...
	{ ATF_POINTER, 5, offsetof(struct MeasObjectNR, blackCellsToAddModList),
		(ASN_TAG_CLASS_CONTEXT | (15 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct MeasObjectNR, whiteCellsToRemoveList),
	...
	{ ATF_POINTER, 3, offsetof(struct MeasObjectNR, whiteCellsToAddModList),
		(ASN_TAG_CLASS_CONTEXT | (17 << 2)),
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct MeasObjectNR, freqBandIndicatorNR_v1530),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasObjectNR, measCycleSCell_v1530),
		(ASN_TAG_CLASS_CONTEXT | (19 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_measCycleSCell_v1530_24,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"measCycleSCell-v1530"
...
static const int asn_MAP_MeasObjectNR_oms_1[] = { 0, 1, 2, 3, 4, 6, 7, 8, 9, 12, 13, 14, 15, 16, 17, 18, 19 };
...
static const asn_TYPE_tag2member_t asn_MAP_MeasObjectNR_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (18 << 2)), 18, 0, 0 }, /* freqBandIndicatorNR-v1530 */
    { (ASN_TAG_CLASS_CONTEXT | (19 << 2)), 19, 0, 0 } /* measCycleSCell-v1530 */
};
