...
static int
memb_txDirectCurrentLocation_v1530_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_txDirectCurrentLocation_v1530_constr_6 CC_NOTUSED = {
	{ 2, 1 }	/* (0..4095) */,
	-1};
static asn_per_constraints_t asn_PER_memb_txDirectCurrentLocation_v1530_constr_6 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_SCS_SpecificCarrier_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SCS_SpecificCarrier, txDirectCurrentLocation_v1530),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_txDirectCurrentLocation_v1530_constr_6, &asn_PER_memb_txDirectCurrentLocation_v1530_constr_6,  memb_txDirectCurrentLocation_v1530_constraint_1 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_SCS_SpecificCarrier_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* txDirectCurrentLocation-v1530 */
};
