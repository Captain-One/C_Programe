...
static int
memb_requestedPDCCH_BlindDetectionSCG_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_requestedPDCCH_BlindDetectionSCG_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (1..15) */,
	-1};
static asn_per_constraints_t asn_PER_memb_requestedPDCCH_BlindDetectionSCG_constr_5 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_ConfigRestrictModReqSCG_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct ConfigRestrictModReqSCG, requestedPDCCH_BlindDetectionSCG),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_requestedPDCCH_BlindDetectionSCG_constr_5, &asn_PER_memb_requestedPDCCH_BlindDetectionSCG_constr_5,  memb_requestedPDCCH_BlindDetectionSCG_constraint_1 },
		0, 0, /* No default value */
		"requestedPDCCH-BlindDetectionSCG"
		},
	{ ATF_POINTER, 1, offsetof(struct ConfigRestrictModReqSCG, requestedP_MaxEUTRA),
