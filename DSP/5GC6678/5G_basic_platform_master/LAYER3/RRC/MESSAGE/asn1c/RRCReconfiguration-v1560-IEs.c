...
static asn_oer_constraints_t asn_OER_memb_radioBearerConfig2_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
static asn_per_constraints_t asn_PER_memb_radioBearerConfig2_constr_3 CC_NOTUSED = {
...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_5 = {
	sizeof(struct RRCReconfiguration_v1560_IEs__nonCriticalExtension),
	offsetof(struct RRCReconfiguration_v1560_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_RRCReconfiguration_v1560_IEs_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct RRCReconfiguration_v1560_IEs, radioBearerConfig2),
		...
		0,
		{ &asn_OER_memb_radioBearerConfig2_constr_3, &asn_PER_memb_radioBearerConfig2_constr_3,  memb_radioBearerConfig2_constraint_1 },
		0, 0, /* No default value */
		"radioBearerConfig2"
		},
