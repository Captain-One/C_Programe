...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_4 = {
	sizeof(struct MeasurementTimingConfiguration_v1550_IEs__nonCriticalExtension),
	offsetof(struct MeasurementTimingConfiguration_v1550_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
