...
static asn_TYPE_member_t asn_MBR_noSIB1_4[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CGI_InfoNR__noSIB1, ssb_SubcarrierOffset),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CGI_InfoNR__noSIB1, pdcch_ConfigSIB1),
...
static asn_SEQUENCE_specifics_t asn_SPC_noSIB1_specs_4 = {
	sizeof(struct CGI_InfoNR__noSIB1),
	offsetof(struct CGI_InfoNR__noSIB1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_CGI_InfoNR_1[] = {
	{ ATF_POINTER, 3, offsetof(struct CGI_InfoNR, plmn_IdentityInfoList),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct CGI_InfoNR, frequencyBandList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct CGI_InfoNR, noSIB1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_noSIB1_4,
		0,
...
static const int asn_MAP_CGI_InfoNR_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_CGI_InfoNR_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CGI_InfoNR_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_CGI_InfoNR_specs_1 = {
	sizeof(struct CGI_InfoNR),
	offsetof(struct CGI_InfoNR, _asn_ctx),
	asn_MAP_CGI_InfoNR_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_CGI_InfoNR_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	3,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_CGI_InfoNR = {
	"CGI-InfoNR",
	"CGI-InfoNR",
	&asn_OP_SEQUENCE,
	asn_DEF_CGI_InfoNR_tags_1,
	sizeof(asn_DEF_CGI_InfoNR_tags_1)
		/sizeof(asn_DEF_CGI_InfoNR_tags_1[0]), /* 1 */
	asn_DEF_CGI_InfoNR_tags_1,	/* Same as above */
	sizeof(asn_DEF_CGI_InfoNR_tags_1)
		/sizeof(asn_DEF_CGI_InfoNR_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_CGI_InfoNR_1,
	3,	/* Elements count */
	&asn_SPC_CGI_InfoNR_specs_1	/* Additional specs */
};
