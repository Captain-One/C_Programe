...
static asn_TYPE_member_t asn_MBR_rach_ConfigDedicated_13[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ReconfigurationWithSync__rach_ConfigDedicated, choice.uplink),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ReconfigurationWithSync__rach_ConfigDedicated, choice.supplementaryUplink),
...
asn_TYPE_member_t asn_MBR_ReconfigurationWithSync_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ReconfigurationWithSync, smtc),
