...
asn_TYPE_member_t asn_MBR_PortIndexFor8Ranks_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PortIndexFor8Ranks, choice.portIndex8),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PortIndexFor8Ranks, choice.portIndex4),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PortIndexFor8Ranks, choice.portIndex2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
