...
static int
memb_startingBitOfFormat2_3SUL_v1530_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_startingBitOfFormat2_3SUL_v1530_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (1..31) */,
	-1};
static asn_per_constraints_t asn_PER_memb_startingBitOfFormat2_3SUL_v1530_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 5,  5,  1,  31 }	/* (1..31) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_SRS_TPC_CommandConfig_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SRS_TPC_CommandConfig, startingBitOfFormat2_3SUL_v1530),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_startingBitOfFormat2_3SUL_v1530_constr_5, &asn_PER_memb_startingBitOfFormat2_3SUL_v1530_constr_5,  memb_startingBitOfFormat2_3SUL_v1530_constraint_1 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_SRS_TPC_CommandConfig_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* startingBitOfFormat2-3SUL-v1530 */
};
