...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UL_CCCH1_MessageType__c1, choice.rrcResumeRequest1),
...
asn_TYPE_member_t asn_MBR_UL_CCCH1_MessageType_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UL_CCCH1_MessageType, choice.c1),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UL_CCCH1_MessageType, choice.messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
