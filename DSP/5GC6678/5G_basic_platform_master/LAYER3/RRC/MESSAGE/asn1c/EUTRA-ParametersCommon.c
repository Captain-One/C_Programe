...
static asn_oer_constraints_t asn_OER_type_ne_DC_constr_10 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_ne_DC_constr_10 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_ne_DC_value2enum_10[] = {
	{ 0,	9,	"supported" }
};
static const unsigned int asn_MAP_ne_DC_enum2value_10[] = {
	0	/* supported(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_ne_DC_specs_10 = {
	asn_MAP_ne_DC_value2enum_10,	/* "tag" => N; sorted by tag */
	asn_MAP_ne_DC_enum2value_10,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_ne_DC_tags_10[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ne_DC_10 = {
	"ne-DC",
	"ne-DC",
	&asn_OP_NativeEnumerated,
	asn_DEF_ne_DC_tags_10,
	sizeof(asn_DEF_ne_DC_tags_10)
		/sizeof(asn_DEF_ne_DC_tags_10[0]) - 1, /* 1 */
	asn_DEF_ne_DC_tags_10,	/* Same as above */
	sizeof(asn_DEF_ne_DC_tags_10)
		/sizeof(asn_DEF_ne_DC_tags_10[0]), /* 2 */
	{ &asn_OER_type_ne_DC_constr_10, &asn_PER_type_ne_DC_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_ne_DC_specs_10	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_EUTRA_ParametersCommon_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct EUTRA_ParametersCommon, ne_DC),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ne_DC_10,
		0,
