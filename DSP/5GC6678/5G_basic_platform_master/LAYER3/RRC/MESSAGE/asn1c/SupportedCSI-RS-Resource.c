...
static asn_oer_constraints_t asn_OER_memb_maxNumberResourcesPerBand_constr_10 CC_NOTUSED = {
	{ 1, 1 }	/* (1..64) */,
	-1};
...
static asn_oer_constraints_t asn_OER_memb_totalNumberTxPortsPerBand_constr_11 CC_NOTUSED = {
	{ 2, 1 }	/* (2..256) */,
	-1};
...
asn_TYPE_member_t asn_MBR_SupportedCSI_RS_Resource_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SupportedCSI_RS_Resource, maxNumberResourcesPerBand),
		...
		0,
		{ &asn_OER_memb_maxNumberResourcesPerBand_constr_10, &asn_PER_memb_maxNumberResourcesPerBand_constr_10,  memb_maxNumberResourcesPerBand_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SupportedCSI_RS_Resource, totalNumberTxPortsPerBand),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_totalNumberTxPortsPerBand_constr_11, &asn_PER_memb_totalNumberTxPortsPerBand_constr_11,  memb_totalNumberTxPortsPerBand_constraint_1 },
		0, 0, /* No default value */
