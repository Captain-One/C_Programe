...
static asn_oer_constraints_t asn_OER_type_pdsch_RE_MappingFR1_PerSlot_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_pdsch_RE_MappingFR1_PerSlot_constr_12 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_pdsch_RE_MappingFR1_PerSlot_value2enum_12[] = {
	{ 0,	3,	"n16" },
	{ 1,	3,	"n32" },
	{ 2,	3,	"n48" },
	{ 3,	3,	"n64" },
...
static const unsigned int asn_MAP_pdsch_RE_MappingFR1_PerSlot_enum2value_12[] = {
	6,	/* n112(6) */
	7,	/* n128(7) */
	8,	/* n144(8) */
	0,	/* n16(0) */
...
static const asn_INTEGER_specifics_t asn_SPC_pdsch_RE_MappingFR1_PerSlot_specs_12 = {
	asn_MAP_pdsch_RE_MappingFR1_PerSlot_value2enum_12,	/* "tag" => N; sorted by tag */
	asn_MAP_pdsch_RE_MappingFR1_PerSlot_enum2value_12,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_pdsch_RE_MappingFR1_PerSlot_tags_12[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_pdsch_RE_MappingFR1_PerSlot_12 = {
	"pdsch-RE-MappingFR1-PerSlot",
	"pdsch-RE-MappingFR1-PerSlot",
	&asn_OP_NativeEnumerated,
	asn_DEF_pdsch_RE_MappingFR1_PerSlot_tags_12,
	sizeof(asn_DEF_pdsch_RE_MappingFR1_PerSlot_tags_12)
		/sizeof(asn_DEF_pdsch_RE_MappingFR1_PerSlot_tags_12[0]) - 1, /* 1 */
	asn_DEF_pdsch_RE_MappingFR1_PerSlot_tags_12,	/* Same as above */
	sizeof(asn_DEF_pdsch_RE_MappingFR1_PerSlot_tags_12)
		/sizeof(asn_DEF_pdsch_RE_MappingFR1_PerSlot_tags_12[0]), /* 2 */
	{ &asn_OER_type_pdsch_RE_MappingFR1_PerSlot_constr_12, &asn_PER_type_pdsch_RE_MappingFR1_PerSlot_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_pdsch_RE_MappingFR1_PerSlot_specs_12	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_Phy_ParametersFR1_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct Phy_ParametersFR1, pdsch_RE_MappingFR1_PerSlot),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_pdsch_RE_MappingFR1_PerSlot_12,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"pdsch-RE-MappingFR1-PerSlot"
