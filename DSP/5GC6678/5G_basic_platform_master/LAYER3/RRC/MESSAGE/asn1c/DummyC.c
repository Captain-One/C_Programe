...
asn_TYPE_member_t asn_MBR_DummyC_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DummyC, maxNumberTxPortsPerResource),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyC, maxNumberResources),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyC, totalNumberTxPorts),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyC, supportedCodebookMode),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyC, supportedNumberPanels),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DummyC, maxNumberCSI_RS_PerResourceSet),
...
static const ber_tlv_tag_t asn_DEF_DummyC_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_DummyC_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_DummyC_specs_1 = {
	sizeof(struct DummyC),
	offsetof(struct DummyC, _asn_ctx),
	asn_MAP_DummyC_tag2el_1,
	6,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_DummyC = {
	"DummyC",
	"DummyC",
	&asn_OP_SEQUENCE,
	asn_DEF_DummyC_tags_1,
	sizeof(asn_DEF_DummyC_tags_1)
		/sizeof(asn_DEF_DummyC_tags_1[0]), /* 1 */
	asn_DEF_DummyC_tags_1,	/* Same as above */
	sizeof(asn_DEF_DummyC_tags_1)
		/sizeof(asn_DEF_DummyC_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_DummyC_1,
	6,	/* Elements count */
	&asn_SPC_DummyC_specs_1	/* Additional specs */
};
