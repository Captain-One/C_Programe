...
//  rlc_am_tx_sdu_management_t   *input_sdus;           /*!< \brief Input SDU buffer (for SDUs coming from upper layers). */
  list2_t			input_sdus;								/*!< \brief Input SDU list (for SDUs coming from upper layers). */
  mem_block_t*	transmit_sdu_mbP;
...
//  poll_sn;      /*!< \brief  Poll send state variable. This state variable holds the value of VT(S)-1 upon the most recent transmission of a RLC data PDU with the poll bit set to “1”. It is initially set to 0.*/
  ...
  int32_t RX_Next;
  int32_t RX_Next_Highest;
  int32_t RX_Highest_Status;
  int32_t RX_Next_Status_Trigger;
  ...
  uint32_t           tx_sn_modulo;                     /*!< \brief Module of the sequence number of PDU, can be RLC_UM_SN_5_BITS_MODULO or RLC_UM_SN_10_BITS_MODULO. */
  uint32_t           rx_sn_modulo;                     /*!< \brief Module of the sequence number of PDU, can be RLC_UM_SN_5_BITS_MODULO or RLC_UM_SN_10_BITS_MODULO. */
  uint32_t           rx_am_window_size;
  uint32_t           tx_am_window_size;
