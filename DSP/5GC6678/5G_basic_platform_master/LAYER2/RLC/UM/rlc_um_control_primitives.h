...
typedef volatile struct {
	...
	uint32_t             sn_field_length; // 6 or 12
...
*/
void config_req_rlc_um (const protocol_ctxt_t* const ctxt_pP,
							const srb_flag_t srb_flagP,
							const rlc_um_info_t * const config_umP,
							const rb_id_t rb_idP,
...
*/
void rlc_um_init (const protocol_ctxt_t* const ctxt_pP, rlc_um_entity_t * const rlc_pP);
...
* \param[in]  rlc_pP                    RLC UM protocol instance pointer.
*/
void rlc_um_reset_state_variables (const protocol_ctxt_t* const ctxt_pP, rlc_um_entity_t * const rlc_pP);
...
*/
void rlc_um_configure(const protocol_ctxt_t* const ctxt_pP,
							rlc_um_entity_t *const  rlc_pP,
							const uint32_t timer_reorderingP,
							const uint32_t rx_sn_field_lengthP,
							const uint32_t tx_sn_field_lengthP,
...
* \param[in]  chan_idP                  Transport channel identifier.
*/
void rlc_um_set_debug_infos(const protocol_ctxt_t* const ctxt_pP,
									rlc_um_entity_t * const rlc_pP,
									const srb_flag_t srb_flagP,
									const rb_id_t rb_idP,
									const logical_chan_id_t chan_idP);
