...
//								const rlc_sn_t start_snP,
//								const rlc_sn_t end_snP);
...
*/
void rlc_um_init_timer_reordering(const protocol_ctxt_t* const ctxt_pP,
										rlc_um_entity_t * const rlc_pP,
...
signed int rlc_um_in_window(const protocol_ctxt_t* const ctxt_pP,
									rlc_um_entity_t * const rlc_pP,
									const rlc_sn_t lower_boundP,
									const rlc_sn_t snP,
									const rlc_sn_t higher_boundP);
...
void rlc_um_receive_process_dar (
  const protocol_ctxt_t* const ctxt_pP,
  rlc_um_entity_t * const      rlc_pP,
  mem_block_t *                pdu_mem_pP,
