...
* \param[in]  rlcP                RLC TM protocol instance pointer.
*/
void rlc_tm_no_segment (const protocol_ctxt_t* const  ctxt_pP, rlc_tm_entity_t *const rlcP);
...
*/
void rlc_tm_rx (const protocol_ctxt_t* const  ctxt_pP, void *const rlcP, struct mac_data_ind data_indP);
...
*/
struct mac_status_resp rlc_tm_mac_status_indication (const protocol_ctxt_t* const  ctxt_pP,
																void * const                  rlc_pP,
...
*/
struct mac_data_req  rlc_tm_mac_data_request (const protocol_ctxt_t* const  ctxt_pP, void * const rlcP);
...
* \param[in]  data_indP                 PDUs from MAC.
*/
void rlc_tm_mac_data_indication (const protocol_ctxt_t* const  ctxt_pP, void * const rlcP, struct mac_data_ind data_indP);
...
*/
void rlc_tm_data_req (const protocol_ctxt_t* const  ctxt_pP, void * const rlcP, mem_block_t * const sduP);
