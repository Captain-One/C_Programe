...
#define RLC_SI_DATA_FIELD_CONTAINS_ALL_BYTES_OF_AN_RLC_SDU         						0x0
#define RLC_SI_DATA_FIELD_CONTAINS_THE_FIRST_SEGMENT_OF_AN_RLC_SDU     					0x1
#define RLC_SI_DATA_FIELD_CONTAINS_THE_LAST_SEGMENT_OF_AN_RLC_SDU     					0x2
#define RLC_SI_DATA_FIELD_CONTAINS_NEITHER_THE_FIRST_NOR_LAST_SEGMENT_OF_AN_RLC_SDU 	0x3
