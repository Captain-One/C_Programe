...
build-1623039889:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1623039889-inproc

build-1623039889-inproc: ../app.cfg
	@echo 'Building file: "$<"'
