...
override PKGDIR = cyhc/dsp/core7
...
package/%.xdc.inc package/%_cyhc.dsp.core7.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package cyhc.dsp.core7" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js cyhc.dsp.core7 $@
...
.PHONY: release,cyhc_dsp_core7
ifeq (,$(MK_NOGENDEPS))
-include package/rel/cyhc_dsp_core7.zip.dep
endif
package/rel/cyhc_dsp_core7/cyhc/dsp/core7/package/package.rel.xml: package/package.bld.xml
package/rel/cyhc_dsp_core7/cyhc/dsp/core7/package/package.rel.xml: package/build.cfg
package/rel/cyhc_dsp_core7/cyhc/dsp/core7/package/package.rel.xml: package/package.xdc.inc
package/rel/cyhc_dsp_core7/cyhc/dsp/core7/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/cyhc_dsp_core7/cyhc/dsp/core7/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

cyhc_dsp_core7.zip: package/rel/cyhc_dsp_core7.xdc.inc package/rel/cyhc_dsp_core7/cyhc/dsp/core7/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/cyhc_dsp_core7.xdc.inc,package/rel/cyhc_dsp_core7.zip.dep)


release release,cyhc_dsp_core7: all cyhc_dsp_core7.zip
clean:: .clean
	-$(RM) cyhc_dsp_core7.zip
	-$(RM) package/rel/cyhc_dsp_core7.xdc.inc
	-$(RM) package/rel/cyhc_dsp_core7.zip.dep
