...
override PKGDIR = cyhc/dsp/core5
...
package/%.xdc.inc package/%_cyhc.dsp.core5.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package cyhc.dsp.core5" (because $@ is older than $(firstword $?))" ...
...
package/package.cfg.xdc.inc: .interfaces $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js cyhc.dsp.core5 $@
...
.PHONY: release,cyhc_dsp_core5
ifeq (,$(MK_NOGENDEPS))
-include package/rel/cyhc_dsp_core5.zip.dep
endif
package/rel/cyhc_dsp_core5/cyhc/dsp/core5/package/package.rel.xml: package/package.bld.xml
package/rel/cyhc_dsp_core5/cyhc/dsp/core5/package/package.rel.xml: package/build.cfg
package/rel/cyhc_dsp_core5/cyhc/dsp/core5/package/package.rel.xml: package/package.xdc.inc
package/rel/cyhc_dsp_core5/cyhc/dsp/core5/package/package.rel.xml: package/package.cfg.xdc.inc
package/rel/cyhc_dsp_core5/cyhc/dsp/core5/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

cyhc_dsp_core5.zip: package/rel/cyhc_dsp_core5.xdc.inc package/rel/cyhc_dsp_core5/cyhc/dsp/core5/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/cyhc_dsp_core5.xdc.inc,package/rel/cyhc_dsp_core5.zip.dep)


release release,cyhc_dsp_core5: all cyhc_dsp_core5.zip
clean:: .clean
	-$(RM) cyhc_dsp_core5.zip
	-$(RM) package/rel/cyhc_dsp_core5.xdc.inc
	-$(RM) package/rel/cyhc_dsp_core5.zip.dep
