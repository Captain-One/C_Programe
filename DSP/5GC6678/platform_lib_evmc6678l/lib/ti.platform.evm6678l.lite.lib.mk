...
#*******************************************************************************
#* FILE NAME: ./lib/ti.platform.evm6678l.lite.lib.mk
#*
...
OBJEXT = lite.oe66
AOBJEXT = lite.se66
INTERNALDEFS = -Dti_targets_elf_C66 -D_PLATFORM_LITE_  -DMAKEFILE_BUILD -eo.$(OBJEXT) -ea.$(AOBJEXT) -fr=$(@D) -fs=$(@D) -ppa -ppd=$@.dep
...
$(COMMONSRCCOBJS):.\lib\ti.platform.evm6678l.lite.lib.mk
.\lib\ti.platform.evm6678l.lite.lib.mk:
...
$(LIBDIR)/$(ARLITEDIR)/ti.platform.evm6678l.lite.lib : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
