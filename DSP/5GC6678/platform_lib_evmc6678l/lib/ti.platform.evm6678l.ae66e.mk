...
#*******************************************************************************
#* FILE NAME: ./lib/ti.platform.evm6678l.ae66e.mk
#*
...
empty =
space =$(empty) $(empty)
CC = $(C6X_GEN_INSTALL_PATH)/bin/cl6x -c -mo -o3 -q -k -eo.o -DBIGENDIAN -me -mv6600 --abi=elfabi
...
$(COMMONSRCCOBJS):.\lib\ti.platform.evm6678l.ae66e.mk
.\lib\ti.platform.evm6678l.ae66e.mk:
...
$(LIBDIR)/$(ARRELDIR)/ti.platform.evm6678l.ae66e : $(COMMONSRCCOBJS)
	@echo archiving $? into $@ ...
