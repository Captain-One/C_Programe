...
build-1623039297:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1623039297-inproc

build-1623039297-inproc: ../app.cfg
	@echo 'Building file: "$<"'
