...
#define AD9528_ADDR_CHIP_TYPE			0x003
#define AD9528_ADDR_PRODUCT_ID			0x004
#define AD9528_ADDR_PART_VERSION		0x006
#define AD9528_ADDR_SPI_VERSION			0x00B
#define AD9528_ADDR_VENDOR_ID_L			0x00C
#define AD9528_ADDR_VENDOR_ID_H			0x00D
...
typedef struct {
	...
	ad9528outSourceSel_t
	outSource[14]; //CHANNEL_DIV, PLL1_OUTPUT, SYSREF, INV_PLL1_OUTPUT
