...
/*##################################################################### */
    ...
    * 6 bit divider
    *  PSU_CRL_APB_SDIO1_REF_CTRL_DIVISOR0                         0x14
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E0070, 0x013F3F07U ,0x01011402U)
    */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDRC_RFSHTMG_OFFSET, 0x0FFF83FFU, 0x0092809CU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_DRAMTMG11_POST_MPSM_GAP_X32                        0xf
    ...
    * (OFFSET, MASK, VALUE)      (0XFD07012C, 0x7F1F031FU ,0x0F08010EU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG11_OFFSET, 0x7F1F031FU, 0x0F08010EU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDRC_ADDRMAP8_OFFSET, 0x00001F1FU, 0x00001F08U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080120, 0xFFFFFFFFU ,0x01382B08U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR4_OFFSET, 0xFFFFFFFFU, 0x01382B08U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_14_L3_SEL                              6

    * Configures MIO Pin 14 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF180038, 0x000000FEU ,0x000000C0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_14_OFFSET, 0x000000FEU, 0x000000C0U);
/*##################################################################### */
    ...
    *  PSU_IOU_SLCR_MIO_PIN_15_L3_SEL                              6

    * Configures MIO Pin 15 peripheral interface mapping
    * (OFFSET, MASK, VALUE)      (0XFF18003C, 0x000000FEU ,0x000000C0U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_PIN_15_OFFSET, 0x000000FEU, 0x000000C0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0x0000DFBFU ,0x00004000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0x0000DFBFU, 0x00004000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0x000FC780U ,0x00000000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0x000FC780U, 0x00000000U);
/*##################################################################### */
...
/* Run Vref training in static read mode*/
	...
	Xil_Out32(0xFD080018U, 0x00F022FFU);
...
/*Vref training is complete, disabling static read mode*/
	...
	Xil_Out32(0xFD080018U, 0x00F14777U);
