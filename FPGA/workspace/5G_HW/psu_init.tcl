...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0070 0x013F3F07 0x01011402
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD07012C 0x7F1F031F 0x0F08010E
    ...
    mask_write 0XFD080120 0xFFFFFFFF 0x01382B08
    ...
    mask_write 0XFD0817C4 0xFFFFFFFF 0x000E0000
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180038 0x000000FE 0x000000C0
    ...
    mask_write 0XFF18003C 0x000000FE 0x000000C0
    ...
    mask_write 0XFF180204 0x0000DFBF 0x00004000
    ...
    mask_write 0XFF180208 0x000FC780 0x00000000
