...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = arm_sys_top_arm_sys_i_axi_bram_ctrl_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ucos_uartps
 PARAMETER DRIVER_VER = 1.44
